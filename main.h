...
void change_target_4(float theta);
void heli_camera(float z, float b);
...
extern const color_t COLOR_CLOUD;
...
extern const color_t COLOR_GIFT1;
extern const color_t COLOR_SAND;
extern const color_t COLOR_LIGHTWATER;
